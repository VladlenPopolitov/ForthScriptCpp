...
CORE, CORE-EXT, DOUBLE, EXCEPTION, FILE, FLOAT, MEMORY, SEARCH, SEARCH-EXT, STRING, STRING-EXT, BLOCK, BLOCK-EXT, LOCALS are fully impelemented, all [tests](tests/unittests/testresult.txt) for these words are passed.
==============================================
